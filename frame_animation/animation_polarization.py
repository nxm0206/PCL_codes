...
filename_list1 = glob('D:/measurement_data/20201125/fourier_space/*.tiff')
# print(filename_list1)

filename_list2 = glob('D:/measurement_data/20201126/fourier_space/*.bmp')
count = 0
str_wav = 43
for i in range(len(filename_list1)):
    ...
    count = count+1
dir = 'D:/measurement_data/20201126/'
out = cv2.VideoWriter(dir+'TE_and_TM.avi', cv2.VideoWriter_fourcc(*'DIVX'), 12, size)
