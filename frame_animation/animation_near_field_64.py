...
filename_list = glob('D:/measurement_data/20201124/real_space/*.tiff')
...
for i in range(len(filename_list)):
    ...
    label = 'wavelength = ' + filename_list[i][40:44] + ' nm'
...
out = cv2.VideoWriter(dir+'SOI_64_antenna_wav_scan.avi', cv2.VideoWriter_fourcc(*'DIVX'), 10, size)
